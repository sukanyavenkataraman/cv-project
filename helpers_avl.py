'''
Helper functions such as label_to_text, speller, decoder
'''
import re
import string
...
def _decode(y_pred, input_length, greedy=True, beam_width=100, top_paths=1):
    ...
    decoded = tf.nn.ctc_beam_search_decoder(y_pred, input_length, beam_width=1)
...
class Decoder(object):
    ...
    def decode(self, y_pred, input_length):
        ...
        #print (decoded)
        for output in decoded.values:
            out = output
            #print ('decoded output is  ', out)
